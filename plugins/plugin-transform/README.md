<p align='center'><a
  href="https://www.npmjs.com/package/@freesewing/plugin-transform"
  title="@freesewing/plugin-transform on NPM"
  ><img src="https://img.shields.io/npm/v/@freesewing/plugin-transform.svg"
  alt="@freesewing/plugin-transform on NPM"/>
  </a><a
  href="https://opensource.org/licenses/MIT"
  title="License: MIT"
  ><img src="https://img.shields.io/npm/l/@freesewing/plugin-transform.svg?label=License"
  alt="License: MIT"/>
  </a><a
  href="#contributors-"
...
A FreeSewing plugin to transform (translate, rotate, or scale) points or paths
...
This folder holds: @freesewing/plugin-transform
