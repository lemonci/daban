import { buildOutlinePaths, buildSaPaths } from '@freesewing/toni'
...
function tinaFrontBottom({ paths, points, part, snippets, Snippet, store, macro, sa }) {
  ...
  buildOutlinePaths(part, store.get('bottomPathBuilder'))
  buildSaPaths(part, store.get('bottomPathBuilder'))
