...
export const body = {
  ...
  draft: ({
    ...
    points.eyeBigT = points.eyeBig.shift(90, eyeBigY)
    points.eyeBigB = points.eyeBig
      .shift(270, eyeBigY)
      .shift(0, options.aggressive ? eyeBigX / 1.5 : 0)
    points.eyeBigR = points.eyeBig
      .shift(0, eyeBigX)
      .shift(270, options.aggressive ? eyeBigY / 1.5 : 0)
    points.eyeBigL = points.eyeBig.shift(180, eyeBigX)
    points.eyeBigTcp1 = points.eyeBigT.shift(0, eyeBigY * c)
    points.eyeBigTcp2 = points.eyeBigT.shift(180, eyeBigY * c)
    points.eyeBigBcp1 = points.eyeBigB.shift(180, eyeBigY * c)
    points.eyeBigBcp2 = points.eyeBigB.shift(0, eyeBigY * c)
    points.eyeBigRcp1 = points.eyeBigR.shift(270, (eyeBigX / (options.aggressive ? 1.5 : 1)) * c)
    points.eyeBigRcp2 = points.eyeBigR.shift(90, eyeBigX * c)
    points.eyeBigLcp1 = points.eyeBigL.shift(90, eyeBigX * c)
    points.eyeBigLcp2 = points.eyeBigL.shift(270, eyeBigX * c)
    ...
    points.eyeSmallT = points.eyeSmall.shift(270, eyeSmallY)
    points.eyeSmallB = points.eyeSmall.shift(90, eyeSmallY)
    points.eyeSmallR = points.eyeSmall.shift(0, eyeSmallX)
    points.eyeSmallL = points.eyeSmall.shift(180, eyeSmallX)
    points.eyeSmallTcp1 = points.eyeSmallT.shift(0, eyeSmallY * c)
    points.eyeSmallTcp2 = points.eyeSmallT.shift(180, eyeSmallY * c)
    points.eyeSmallBcp1 = points.eyeSmallB.shift(180, eyeSmallY * c)
    points.eyeSmallBcp2 = points.eyeSmallB.shift(0, eyeSmallY * c)
    points.eyeSmallRcp1 = points.eyeSmallR.shift(270, eyeSmallX * c)
    points.eyeSmallRcp2 = points.eyeSmallR.shift(90, eyeSmallX * c)
    points.eyeSmallLcp1 = points.eyeSmallL.shift(90, eyeSmallX * c)
    points.eyeSmallLcp2 = points.eyeSmallL.shift(270, eyeSmallX * c)
