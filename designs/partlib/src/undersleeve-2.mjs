...
function draftUnderSleeve2({ macro, Path, points, paths, snippets, Snippet, sa, store, part }) {
...
export const underSleeve2 = {
  name: 'partlib.underSleeve2',
  from: sleeve2,
  draft: draftUnderSleeve2,
}
