...
export const boxPleatFold = {
  pct: 15,
  min: 10,
  max: 20,
  toAbs: (val, { measurements }, mergedOptions) =>
    measurements.shoulderToShoulder * mergedOptions.boxPleatWidth * val,
  menu: 'advanced',
}
export const boxPleatWidth = {
  pct: 7,
  min: 4,
  max: 10,
...
export const buttonholePlacketStyle = {
  ...
  menu: (_settings, mergedOptions) =>
    mergedOptions?.separateButtonholePlacket ? false : 'style.closure',
}
export const buttonholePlacketWidth = {
  pct: 8,
  min: 4,
  max: 12,
  ...pctBasedOn('neck'),
...
export const buttonholePlacketFoldWidth = {
  pct: 16,
  min: 8,
  max: 24,
  toAbs: (val, { measurements }, mergedOptions) =>
    measurements.neck * mergedOptions.buttonholePlacketWidth * val,
  menu: 'style.closure',
}
export const buttonPlacketStyle = {
  ...
  dflt: 'classic',
  menu: (_settings, mergedOptions) =>
    mergedOptions?.separateButtonPlacket ? false : 'style.closure',
}
export const buttonPlacketWidth = {
  pct: 5,
  min: 2,
  max: 8,
  ...pctBasedOn('neck'),
...
// Cuffs
export const barrelCuffNarrowButton = {
  bool: true,
  menu: (_settings, mergedOptions) =>
    mergedOptions?.sleeveStyle === 'short' ? false : 'style.cuffs',
}
export const cuffButtonRows = {
  count: 1,
  min: 1,
  max: 2,
  menu: (_settings, mergedOptions) =>
...
export const hipsEase = { pct: 15, min: 10, max: 35, ...pctBasedOn('hips'), menu: 'fit' }
export const lengthBonus = { pct: 25, min: -4, max: 60, menu: 'fit' }
// Shoulders
export const shoulderEase = {
  pct: 2,
  min: 0,
  max: 15,
  ...pctBasedOn('shoulderToShoulder'),
...
// Sleeve
export const sleeveLengthBonus = {
  pct: 3.5,
  min: -40,
  max: 10,
...
export const sleeveLengthShort = {
  pct: 40,
  min: 20,
  max: 100,
  ...pctBasedOn('shoulderToWrist'),
...
export const sleevePlacketLength = {
  pct: 25,
  min: 15,
  max: 35,
  ...pctBasedOn('shoulderToWrist'),
...
export const sleevePlacketWidth = {
  pct: 13,
  min: 8,
  max: 18,
  ...pctBasedOn('wrist'),
...
export const waistEase = { pct: 15, min: 10, max: 35, ...pctBasedOn('waist'), menu: 'fit' }
