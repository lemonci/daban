...
export const backInside = {
  ...
  options: {
    ...
    backHemSlope: 0, // ensures that the back part gets a straight side seam
  },
  draft: ({ sa, store, points, Path, paths, options, macro, part }) => {
    ...
    store.set('backArmholeDartPosition', backArmholeDartPosition)
