...
export const designs = {
  aaron: {
    ...
    s: {
      ...
      'cutArmBinding.d':
        'The **Arm opening knit binding** are two strips of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutNeckBinding.t': 'The neck opening knit binding is not shown',
      'cutNeckBinding.d':
        'The **Neck opening knit binding** is a strip of fabric {{{ width }}} wide and {{{ length }}} long.',
      ...
      'largeSaAdaptKnitBindingWidth.d':
        'The default width of the knit binding is 6 times the seam allowance. Because your chosen seam allowance ({{{ sa }}}) is larger than the 1cm used when designing the pattern, your knit binding is likely to be too wide. \n\nYou can lower the knit binding width to compensate for your larger seam allowance.',
      length: 'Length',
      width: 'Width',
    },
    p: {
  ...
  albert: {
    ...
    s: {
      ...
      'cutPocket.d':
        'The **Pocket** is a rectangular piece of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutStrap.t': 'The straps are not currently shown',
      'cutStrap.d':
        'The **Straps** are two strips of fabric {{{ width }}} wide and {{{ length }}} long.',
      foldHere: 'Fold here',
    },
    o: {
      backOpening: {
  ...
  bee: {
    ...
    s: {
      ...
      'cbSeamBustBelowWaist.d':
        "No solution was found to place the bust point above the waist line on the center back seam. As a compromise, we've used the waist height instead. \n\nPlease verify your measurements before contacting support.",
      'sideSeamBustBelowWaist.t': 'Bust height compromised at side seam',
      'sideSeamBustBelowWaist.d':
        "No solution was found to place the bust point above the waist line on the side seam. As a compromise, we've used the waist height instead. \n\nPlease verify your measurements before contacting support.",
      'bustDartCompromise.t': 'Bust dart tip compromised',
      'bustDartCompromise.d':
        'No solution was found to adjust the bust dart. As a compromise we are using the bust draft as initially drafted.\n\nPlease verify your measurements before contacting support.',
  ...
  benjamin: {
    ...
    s: {
      ...
      'cutCollarBandFlag.d':
        'The **Collar band** are two strips of fabric {{ height }} wide and {{ length }} long.',
    },
    o: {
      adjustmentRibbon: {
        t: 'Adjustment ribbon',
  ...
  bibi: {
    ...
    s: {
      ...
      'length.floor.d':
        'Create a floor-length dress. Use a negative length bonus to prevent the garment from actually dragging on the floor.',
      'cutCuff.t': 'The cuff is not shown',
      'cutCuff.d':
        'The **Cuff** (6) is a rectangular piece of ribbing fabric {{{ w }}} wide and {{{ l }}} long.',
      'cutWaistband.t': 'The waistband is not shown',
      'cutWaistband.d':
        'The **Waistband** (5) is a rectangular piece of ribbing fabric {{{ w }}} wide and {{{ l }}} long.',
      'cutNeckBinding.t': 'The neck binding is not shown',
      'cutNeckBinding.d':
        'The **Neck Binding** (3) is a rectangular piece of ribbing fabric {{{ w }}} wide and {{{ l }}} long.',
      'cutArmholeBinding.t': 'The armhole binding is not shown',
      'cutArmholeBinding.d':
        'The **Armhole Binding** (4) is a rectangular piece of ribbing fabric {{{ w }}} wide and {{{ l }}} long.',
  ...
  bob: {
    ...
    s: {
      ...
      'biasTapeLength.d':
        'To finish the edge, you will need {{{ l }}} of [bias tape](/docs/sewing/bias-tape)',
      fabricNeeded:
        'You need a {{{ w }}} by {{{ h }}} piece of [suitable fabric](/docs/designs/bob/fabric) to make this bib',
  ...
  bonny: {
    ...
    s: {
      ...
      'validationOk.d':
        "Your measurements don't seem to contain any obvious contradictions or problems.",
      'shouldBeLarger-hpsToWaistFront-hpsToBust.t': 'Bust below waist',
      'shouldBeLarger-hpsToWaistFront-hpsToBust.d':
        'The HPS to bust measurement should be smaller than HPS to waist front, since FreeSewing patterns assume that the bust line is higher than the waist line.',
      'shouldBeLarger-hpsToWaistFront-waistToUnderbust.t': 'Underbust above HPS',
      'shouldBeLarger-hpsToWaistFront-waistToUnderbust.d':
        'Waist to underbust must be smaller than HPS to waist front, otherwise the HPS would not be above the underbust line.',
      'shouldBeLarger-hpsToWaistFront-waistToArmpit.t': 'Armpit above HPS',
      'shouldBeLarger-hpsToWaistFront-waistToArmpit.d':
        'Waist to armpit must be smaller than HPS to waist front, otherwise the HPS would not be above the armpit.',
      'shouldBeLarger-hpsToWaistBack-waistToArmpit.t': 'Armpit above HPS',
      'shouldBeLarger-hpsToWaistBack-waistToArmpit.d':
        'Waist to armpit must be smaller than HPS to waist back, otherwise the HPS would not be above the armpit.',
      'shouldBeLarger-shoulderToWrist-shoulderToElbow.t': 'Wrist above elbow',
      'shouldBeLarger-shoulderToWrist-shoulderToElbow.d':
        'Shoulder to wrist should be larger than shoulder to elbow, otherwise the elbow would be farther from the shoulder than the wrist.',
      'shouldBeLarger-waistToFloor-waistToKnee.t': 'Knee below floor',
      'shouldBeLarger-waistToFloor-waistToKnee.d':
        'Waist to knee should be smaller than waist to floor, otherwise the knee would be farther away from the waist than the floor.',
      'shouldBeLarger-waistToKnee-waistToUpperLeg.t': 'Upper leg below knee',
      'shouldBeLarger-waistToKnee-waistToUpperLeg.d':
        'Waist to upper leg should be smaller than waist to knee, otherwise the upper leg would be farther away from the waist than the knee.',
      'shouldBeLarger-waistToUpperLeg-waistToSeat.t': 'Seat below upper leg',
      'shouldBeLarger-waistToUpperLeg-waistToSeat.d':
        'Waist to upper leg should be larger than waist to seat. The seat should be measured around the fullest part of your bum, while the upper leg measurement should be taken around your upper leg, a bit below your crotch. Place your seat measurement around the bum, even if your body is wider around your upper legs.',
      'shouldBeLarger-waistToSeat-waistToHips.t': 'Hips below seat',
      'shouldBeLarger-waistToSeat-waistToHips.d':
        'Waist to seat should be larger than waist to hips as your hips measurement should be taken around the top of your hip bone. FreeSewing designs may not work correctly if your seat measurement is at or above your hips measurement.',
      'shouldBeLarger-waistToFloor-inseam.t': 'Crotch above waist',
      'shouldBeLarger-waistToFloor-inseam.d':
        "The inseam measurement must be smaller than the waist to floor measurement, since the inseam measurement is the distance from the crotch to the floor and the crotch can't be at or above the waist.",
      'shouldBeLarger-crossSeam-crossSeamFront.t': 'Cross seam front',
      'shouldBeLarger-crossSeam-crossSeamFront.d':
        'The cross seam front measurement should be the front part of the cross seam measurement and thus must be smaller than the total cross seam measurement.',
      'shouldBeLarger-seat-seatBack.t': 'Seat',
      'shouldBeLarger-seat-seatBack.d':
        'The seat back measurement should be the back part of the seat measurement and thus must be smaller than the total seat measurement.',
      'shouldBeLarger-highBust-highBustFront.t': 'High Bust',
      'shouldBeLarger-highBust-highBustFront.d':
        'The high bust front measurement should be the front part of the high bust measurement and thus must be smaller than the total high bust measurement.',
      'shouldBeLarger-chest-bustFront.t': 'Chest',
      'shouldBeLarger-chest-bustFront.d':
        'The bust front measurement should be the front part of the chest measurement and thus must be smaller than the total chest measurement.',
      'shouldBeLarger-bustFront-bustSpan.t': 'Bust span',
      'shouldBeLarger-bustFront-bustSpan.d':
        "The bust span measurement can't be larger than the bust front measurement.",
      'shouldBeLarger-waist-waistBack.t': 'Waist circumference',
      'shouldBeLarger-waist-waistBack.d':
        'The waist back measurement should be the back part of the waist circumference measurement and thus must be smaller than the total waist circumference.',
      'constraint-backChest.t': 'Back chest',
      'constraint-backChest.d':
      ...
      'constraint-waistFront.d':
        "Measuring from the HPS point directly to the waist across your front can't be larger than the sum of the individual vertical bust measurements (hps to bust, bustpoint to underbust, waist to underbust). However note that waist to underbust is measured at the side of the body instead of at the front, but usually this doesn't make a large difference.",
      'constraint-waistToUpperLeg.t': 'Upper leg above crotch',
      'constraint-waistToUpperLeg.d':
        'The waist-to-upper-leg measurement goes from the waist along the body to a bit below the crotch and the inseam measurement goes vertically from the crotch to the floor. Thus, waist to upper leg should be a bit larger than the difference between waist to floor and the inseam measurement.',
      'constraint-waistBack.t': 'Back waist',
      'constraint-waistBack.d':
        'The waist back measurement is usually not much bigger than half the waist measurement.',
      'constraint-bustFront.t': 'Bust front',
      'constraint-bustFront.d':
        'The bust front measurement is usually a bit larger than half the chest measurement.',
      'constraint-highBustFront.t': 'High bust front',
      'constraint-highBustFront.d':
        'The high bust front measurement is usually roughly half the high bust measurement.',
      'crossseam.t': 'Cross seam',
      'crossseam.d':
        'We could not draw a cross seam curve using your measurements. Double check the inseam measurement and check that waist to seat, waist to upper leg, and the cross seam measurements use the same waist line.',
      'crossseamfront.t': 'Cross seam front',
      'crossseamfront.d':
        'We could not determine the fork position on the crotch line. Double check your cross seam measurements and seat measurements.',
    },
    o: {},
  },
  breanna: {
  ...
  carlita: {
    ...
    s: {
      ...
      'cutBackStay.d':
        'The **Back stay** (2a) is not shown, but you can trace it from the Back part (2). Trace the outline above the canvas line that curves from the top of the back fold to under the armhole.',
      'cutChestPocketBag.t': 'The chest pocket bag is not shown',
      'cutChestPocketBag.d':
        'The **Chest pocket bag** (17) is a rectangular piece of fabric {{{ w }}} wide and {{{ l }}} long.',
      'cutChestPocketWelt.t': 'The chest pocket welt is not shown',
      'cutChestPocketWelt.d':
        'The **Chest pocket welt** (12) is a rectangular piece of fabric {{{ w }}} wide and {{{ l }}} long.',
      'cutFrontFacing.t': 'The front facing is not shown',
      'cutFrontFacing.d':
        'The **Front facing** (1a) is not shown, but you can trace it from the Front part (1). Trace the outline left from the facing/lining boundary.',
      'cutFrontLining.t': 'The front lining is not shown',
      'cutFrontLining.d':
        'The **Front lining** (1b) is not shown, but you can trace it from the Front part (1). Trace the outline right from the facing/lining boundary.',
      'cutInnerPocketBag.t': 'The inner pocket bag is not shown',
      'cutInnerPocketBag.d':
        'The **Inner pocket bag** (14) is a rectangle {{{ w }}} wide and {{{ l }}} long.',
      'cutInnerPocketWelt.t': 'The inner pocket welt is not shown',
      'cutInnerPocketWelt.d':
        'The **Inner pocket welt** (13) is a rectangle {{{ w }}} wide and {{{ l }}} long.',
      'cutTail.t': 'The tail is not shown',
      'cutTail.d':
        'The **Tail** (5) is a rectangular piece of fabric {{{ w }}} wide and {{{ l }}} long.',
  ...
  charlie: {
    ...
    s: {
      ...
      'crossSeamFitFailedBack.d':
        "No solution was found to fit the cross seam in the back part. As a compromise, we've used the best available solution instead.\n\nPlease verify your measurements before contacting support.",
      'crossSeamFitFailedFront.t': 'Front cross seam compromised',
      'crossSeamFitFailedFront.d':
        "No solution was found to fit the cross seam in the front part. As a compromise, we've used the best available solution instead.\n\nPlease verify your measurements before contacting support.",
      'lowFrontHeight.t': 'Front waist too low',
      'lowFrontHeight.d':
        'The front cross seam curve was adjusted as the front waistband was unexpectedly low.\n\nThe generated pattern is likely not correct. Please verify your measurements before contacting support.',
      ...
      'cutBeltloops.d':
        'The **Belt loops** are {{{ count }}} rectangular piece of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutBackPocketInterfacing.t': 'The back pocket interfacing is not shown',
      'cutBackPocketInterfacing.d':
        'The **Back pocket interfacing** is a rectangular piece of fusible interfacing {{{ width }}} wide and {{{ length }}} long.',
      'cutWaistband.t': 'The waistband is not shown',
      'cutWaistband.d':
        'The **Waistband** is a rectangular piece of fabric {{{ width }}} wide and {{{ length }}} long.',
    },
    p: {
      back: 'Back',
      front: 'Front',
  ...
  devon: {
    ...
    s: {
      ...
      'cutWaistband.d':
        'The **waist band** is a strip of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutCuff.t': 'The cuffs are not shown',
      'cutCuff.d':
  ...
  hortensia: {
    ...
    s: {
      ...
      'cutBottomPanel.d':
        'The **Bottom panel** is a rectangular of {{{ width }}} wide and {{{ length }}} long.',
      'cutFrontPanel.t': 'The front panel is not shown',
      'cutFrontPanel.d':
        'The **Front panel** is a rectangular of {{{ width }}} wide and {{{ length }}} long.',
      ...
      'cutStrapReducedSa.d':
        'The **Strap** is a rectangular of {{{ width }}} wide and {{{ length }}} long.',
      'cutZipperPanel.t': 'The zipper panel is not shown',
      'cutZipperPanel.d':
        'The **Zipper panel** is a rectangular of {{{ width }}} wide and {{{ length }}} long.',
      strapLength: 'Length of the handles',
      'strapSaReduced.t': 'The strap seam allowance is reduced',
      'strapSaReduced.d':
        'Because of how narrow the strap is, we have reduced the seam allowance on it to be 80% of the strap width',
  ...
  huey: {
    ...
    s: {
      ...
      'cutPocket.d':
        'The **Pocket** (4) is not shown, but you can trace it from the Front part (1), which has the pocket outline on it (not including seam allowance).',
      'cutCuff.t': 'The cuff is not shown',
      'cutCuff.d':
        'The **Cuff** (7) is a rectangular piece of ribbing fabric {{{ w }}} wide and {{{ l }}} long.',
      'cutWaistband.t': 'The waistband is not shown',
      'cutWaistband.d':
        'The **Waistband** (6) is a rectangular piece of ribbing fabric {{{ w }}} wide and {{{ l }}} long.',
      'zipperLength.t': 'The maximum zipper length is {{ length }}',
      'zipperLength.d':
        'You need a zipper with a maximum length of {{ length }}. A slightly shorter zipper will work too.',
  ...
  hugo: {
    ...
    s: {
      ...
      'cutPocket.t': 'The pocket is not shown',
      'cutPocket.d':
        "The **Pocket** (4) is not shown, but you can trace it from the Front part (1), which has the pocket outline on it (not including seam allowance). The front part's cut-on-fold-and-grainline is also the pocket's cut-on-fold-and grainline.",
      'cutCuff.t': 'The cuff is not shown',
      'cutCuff.d':
        'The **Cuff** (9) is a rectangular piece of ribbing fabric {{{ w }}} wide and {{{ l }}} long, with the grainline parallel to the width.',
      'cutHoodCenter.t': 'The hood center is not shown',
      'cutHoodCenter.d':
        'The **Hood center** (7) is a rectangular piece of main fabric {{{ w }}} wide and {{{ l }}} long, with the grainline parallel to the width.',
      'cutNeckBinding.t': 'The neck binding is not shown',
      'cutNeckBinding.d':
        'The **Neck Binding** (10) is a rectangular piece of main fabric {{{ w }}} wide and {{{ l }}} long, with the grainline parallel to the length.',
      'cutWaistband.t': 'The waistband is not shown',
      'cutWaistband.d':
        'The **Waistband** (8) is a rectangular piece of ribbing fabric {{{ w }}} wide and {{{ l }}} long, with the grainline parallel to the width.',
  ...
  jett: {
    ...
    s: {
      ...
      waistLine: 'Waist Line',
      chestLine: 'Chest Line',
      'bustWarning.t': "The bust dart won't be generated",
      'bustWarning.d':
        "Chest is smaller than high bust. If these measurements are accurate, you don't need a bust dart.",
      'waistWarning.t': "The bust dart won't be generated",
      'waistWarning.d':
  ...
  legend: {
    t: 'Legend',
    d: 'A FreeSewing pattern used in our documentation to illustrate pattern notations',
    p: {},
    s: {},
    o: {},
  },
  ...
  lily: {
    ...
    s: {
      ...
      'adjustEase.d':
        'Knee, seat and waist ease should be set to fabric stretch * -1/10; click the button to adjust all three.',
  ...
  magde: {
    t: 'Magde messenger bag',
    d: 'Magde is a pattern for a (bike) messenger bag',
    p: {
      backPanel: 'Back panel',
      bodyLiner: 'Body liner',
      frontPanel: 'Front panel',
      frontOrganiserBase: 'Front organiser base',
      frontOrganiserFront: 'Front organiser front',
      internalOrganiser: 'Internal organiser',
      lidOnePiece: 'Lid one piece',
      sidePanel: 'Side panel',
      strapAttachments: 'Strap attachments',
      twoPieceLidBottom: 'Two-piece lid bottom',
      twoPieceLidTop: 'Two-piece lid top',
    },
    s: {},
    o: {
      size: {
  ...
  octoplushy: {
    ...
    s: {
      ...
      'octopusEye.d':
        'The **Octopus eye** is a circular piece of fabric with a diameter of {{{ width }}}.',
      'octopusPupil.t': 'The octopus pupil is not shown',
      'octopusPupil.d':
        'The **Octopus pupil** is a circular piece of fabric with a diameter of {{{ width }}}.',
      'octopusEyebrow.t': 'The octopus eyebrow is not shown',
      'octopusEyebrow.d':
        'The **Octopus eyebrow** is a rectangular piece of fabric {{{ width }}} wide and {{{ length }}} long.',
      'squidEye.t': 'The squid eye is not shown',
      'squidEye.d':
        'The **Squid eye** is a circular piece of fabric with a diameter of {{{ width }}}.',
      'squidPupil.t': 'The squid pupil is not shown',
      'squidPupil.d':
        'The **Squid pupil** is a circular piece of fabric with a diameter of {{{ width }}}.',
  ...
  onyx: {
    ...
    s: {
      ...
      cutOneCrotchGusset:
        'Cut one rectangle of main fabric\nfor the crotch gusset, with dimensions:',
      cutOneZipperGuard: 'Cut one rectangle of main fabric\nfor the zipper guard, with dimensions:',
      cutNeckband:
        'Cut one rectangle of\nribbing or main fabric\nfor the neckband, with dimensions:',
      'frontOnFoldZipper.t': 'Front Zipper / Front on Fold',
      'frontOnFoldZipper.d':
        'You have selected to place a front zipper, which is not compatible with cutting the front on the fold. When using a front zipper, it is recommended to cut the front as two separate pieces so that you have the seam allowance available to attach the zipper.',
      'backOnFoldZipper.t': 'Back Zipper / Back on Fold',
      'backOnFoldZipper.d':
        'You have selected to place a back zipper, which is not compatible with cutting the back on the fold. When using a back zipper, it is recommended to cut the back as two separate pieces so that you have the seam allowance available to attach the zipper.',
    },
    o: {
      neckbandLength: {
        t: 'Neckband length',
  ...
  opal: {
    ...
    p: {
      ...
      pocketSlashShield: 'Pocket shield',
    ...
    s: {
      ...
      'crossSeamFrontTooSmall.d':
        'The **cross seam front**, of length {{{length}}}, is too short to be drafted onto a body with a seat located {{{depth}}} below the waist and a crotch fork extending {{{girth}}} horizontally beyond the waist. Please check your measurements and options, especially *cross seam front*, *waist to seat*, and *crotch ease*.',
      fold: 'Fold',
  ...
  otis: {
    ...
    s: {
      ...
      'bindingNeckBack.d':
        'The **Back Neck Binding** is a rectangular piece of fabric {{{ width }}} wide and {{{ length }}} long.',
      'bindingNeckFront.t': 'The Front Neck Binding is not shown',
      'bindingNeckFront.d':
        'The **Front Neck Binding** is a rectangular piece of fabric {{{ width }}} wide and {{{ length }}} long.',
      'bindingLeg.t': 'The Leg Binding is not shown',
      'bindingLeg.d':
        'The **Leg Binding** is a rectangular piece of fabric {{{ width }}} wide and {{{ length }}} long.',
    },
    o: {
      binding: {
        t: 'Binding',
  ...
  paco: {
    ...
    s: {
      ...
      'cutCuff.t': 'The cuff is not shown',
      'cutCuff.d':
        'The **Cuff** (4) is a rectangular piece of lining {{{ w }}} wide and {{{ l }}} long.',
      'cutWaistband.t': 'The waistband is not shown',
      'cutWaistband.d':
        'The **Waistband** (3) is a rectangular piece of lining {{{ w }}} wide and {{{ l }}} long.',
      'cutBackPocketBag.t': 'The back pocket bag is not shown',
      'cutBackPocketBag.d':
        'The **Back pocket bag** (6) is a rectangular piece of lining {{{ w }}} wide and {{{ l }}} long.',
      'cutBackPocketWelt.t': 'The back pocket welt is not shown',
      'cutBackPocketWelt.d':
        'The **Back pocket welt** (7) is a rectangular piece of lining {{{ w }}} wide and {{{ l }}} long.',
      'cutBackPocketWeltInterfacing.t': 'The back pocket welt interfacing is not shown',
      'cutBackPocketWeltInterfacing.d':
        'The **Back pocket welt interfacing** (8) is a rectangular piece of fusible interfacing {{{ w }}} wide and {{{ l }}} long.',
    },
    p: {
      back: 'Back',
      front: 'Front',
  ...
  percy: {
    ...
    s: {
      ...
      'cutCuff.t': 'The cuff is not shown',
      'cutCuff.d':
        'The **Cuffs** are two strips of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutPocketFacing.t': 'The pocket facing is not shown',
      'cutPocketFacing.d':
        'The **Pocket Facing** (8) is not shown, but you can trace it from the Pocket (7) piece. Cut off the corner along the outline left from the green lining boundary, but remember your seam allowance.',
    },
    p: {
      back: 'Back',
      front: 'Front',
  ...
  simon: {
    ...
    s: {
      ...
      cutUndercollarSmaller: 'Cut the undercollar a little bit smaller',
    ...
    o: {
      ...
      'backDarts.never': {
        t: 'Never',
        d: 'Never add back darts, handle shaping elsewhere instead',
      },
      'backDarts.always': {
        t: 'Always',
        d: 'Always include back darts, even when shaping is minimal',
      },
      backDartShaping: {
        t: 'Back dart shaping',
        d: 'The amount of shaping that is done by the back darts',
      },
      barrelCuffNarrowButton: {
        t: 'Cuff narrow button',
        d: 'Whether to include a button to tie the cuffs more narrow. This option is only relevant for barrel cuffs.',
      },
      barrelCuffNarrowButtonNo: {
        t: 'Do not include a narrow button',
        d: 'Draft a pattern with a single button on the cuffs',
      },
      barrelCuffNarrowButtonYes: {
      ...
      buttonholePlacketFoldWidth: {
        t: 'Buttonhole placket fold width',
        d: 'Width of the buttonhole placket fold.',
      },
      buttonholePlacketStyle: {
        t: 'Buttonhole placket style',
        d: 'Style of the buttonhole placket.',
      },
      'buttonholePlacketStyle.classic': {
        t: 'Classic buttonhole placket',
        d: 'A classic buttonhole placket with pleats',
      },
      'buttonholePlacketStyle.seamless': {
        t: 'Seamless buttonhole placket',
        d: 'A seamless buttonhole placket gives a more modern look',
      },
      ...
      'cuffStyle.angledBarrelCuff': {
        t: 'Angled  barrel cuff',
        d: 'A classic barrel cuff, but with angled (chamfered) corners',
      },
      'cuffStyle.straightBarrelCuff': {
        t: 'Straight barrel cuff',
        d: 'A classic straight barrel cuff',
      },
      'cuffStyle.roundedFrenchCuff': {
        t: 'Rounded French cuff',
        d: 'A French cuff (the type you need cufflinks for) with rounded corners',
      },
      'cuffStyle.angledFrenchCuff': {
        t: 'Angled French cuff',
        d: 'A French cuff (the type you need cufflinks for) with angled (chamfered) corners',
      },
      'cuffStyle.straightFrenchCuff': {
        t: 'Straight French cuff',
        d: 'A straight French cuff (the type you need cufflinks for)',
      },
      extraTopButton: {
        t: 'Extra top button',
        d: 'Whether or not to include an extra top button between the collar button and the first shirt button on the front closure.',
      },
      extraTopButtonNo: {
        t: 'No extra top button',
        d: 'Draft a pattern without an extra top button',
      },
      extraTopButtonYes: {
        t: 'With extra top button',
        d: 'Draft a pattern with an extra top button',
      },
      ffsa: {
      ...
      separateButtonholePlacketNo: {
        t: 'Do not separate the buttonhole placket',
        d: 'Draft a pattern where the buttonhole placket is attached to the front',
      },
  ...
  sunny: {
    ...
    s: {
      ...
      'cutPanel.d':
        'Each **panel** is a rectangles of fabric {{{ width }}} wide and {{{ length }}} long',
      'ribbonLength.t': 'A ribbon is selected for waistband ties',
      'ribbonLength.d':
        'This will require two lengths of ribbon approximately {{{ waistbandLength }}} long',
      'cutWaistband.t': 'The waistband is not shown',
      'cutWaistband.d':
        'The **waistband** is two rectangles of fabric {{{ width }}} wide and {{{ length }}} long',
      'cutBinding.t': 'The binding is not shown',
      'cutBinding.d':
        'Each **binding** is two rectangles of fabric {{{ width }}} wide and {{{ length }}} long',
      'fabricWaistbandSelected.t': 'A fabric waistband is selected',
      'fabricWaistbandSelected.d':
  ...
  tristan: {
    ...
    s: {
      ...
      'strapWidthAdjusted.d':
        'The strap width has been adjusted to {{{ width }}} to allow for the position of the strap on the shoulder.',
  ...
  umbra: {
    ...
    s: {
      ...
      'legElasticLength.d':
        'If you want to add elastic to your legs, you need two times {{{ length }}}.',
      legMeasure: 'Leg elastic: 2x ',
      'waistbandElasticLength.t': 'You need 1x {{{ length }}} elastic to finish the waistband',
      'waistbandElasticLength.d':
        'You need {{{ length }}} of elastic to finish the waistband opening.',
      waistbandMeasure: 'Waistband elastic: ',
      'minStretch.t': 'You need fabric with a minimum stretch of {{ pct }}',
      'minStretch.d':
        'Your waistband and fabric needs a minimum stretch of {{ pct }} so that you can comfortably fit through the waistband opening.',
    ...
    o: {
      ...
      'pockets.zipper': {
        t: 'Front pockets with zippers',
        d: 'Create two front pockets with zippers',
      },
    },
  },
  wahid: {
    ...
    s: {
      ...
      'cutFrontFacing.t': 'The front facing is not shown',
      'cutFrontFacing.d':
        'The **Front facing** (1a) is not shown, but you can trace it from the Front part (1). Trace the outline on the left of the facing/lining boundary that extends from the tip of the dart to the shoulder seam. \n\nIt is not shown because the **expand** core setting is currently disabled. Enable it to show this pattern part.',
      'cutFrontLining.t': 'The front lining is not shown',
      'cutFrontLining.d':
        'The **Front lining** (1b) is not shown, but you can trace it from the Front part (1). Trace the outline on the right of the facing/lining boundary that extends from the tip of the dart to the shoulder seam. \n\nIt is not shown because the **expand** core setting is currently disabled. Enable it to show this pattern part.',
      'cutPocketWelt.t': 'The pocket welt is not shown',
      'cutPocketWelt.d':
        'The **Pocket welt** (3) is a rectangular piece of fabric {{{ w }}} wide and {{{ l }}} long (this part does not use seam allowance). \n\nIt is not shown because the **expand** core setting is currently disabled. Enable it to show this pattern part.',
      'noBackDart.t': 'The back dart is not necessary',
      'noBackDart.d':
        'Your measurements indicate that a back dart is not necessary, so you can skip this part of the instructions. \n\nSome manual adjustments might be necessary if the chest size measurement is much smaller than the waist and hip size.',
      'cutPocketInterfacing.t': 'The pocket interfacing is not shown',
      'cutPocketInterfacing.d':
        'The **Pocket interfacing** (6) is a rectangular piece of fabric {{{ w }}} wide and {{{ l }}} long (this part does not use seam allowance). \n\nIt is not shown because the **expand** core setting is currently disabled. Enable it to show this pattern part.',
      flbFacingSide: 'Facing/Lining boundary : Facing side',
      flbLiningSide: 'Facing/Lining boundary : Lining side',
    },
    p: {
  ...
  waralee: {
    ...
    s: {
      ...
      'cutBackPocket.d':
        'The **back pocket** is made of two rectangles of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutFacingback.t': 'The back pocket facing is not shown',
      'cutFacingback.d':
        'The **back pocket facing** is made of a rectangle of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutFacingfront.t': 'The front pocket facing is not shown',
      'cutFacingfront.d':
        'The **front pocket facing** is made of a rectangle of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutwaistbandBack.t': 'The back waist band is not shown',
      'cutwaistbandBack.d':
        'The **back waist band** is made of two strips of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutwaistbandFront.t': 'The front waist band is not shown',
      'cutwaistbandFront.d':
        'The **front waist band** is made of two strips of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutstrapBack.t': 'The back strap is not shown',
      'cutstrapBack.d':
        'The **back strap** is made of two strips of fabric {{{ width }}} wide and {{{ length }}} long.',
      'cutstrapFront.t': 'The front strap is not shown',
      'cutstrapFront.d':
        'The **front strap** is made of two strips of fabric {{{ width }}} wide and {{{ length }}} long.',
      'showPants.t': 'The full pants are shown',
      'showPants.d':
        'The **full pants** are shown. This takes up a lot of paper to print. Consider hiding this part, and a minimized version will show with the dimensions.',
