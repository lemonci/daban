...
:::note
If you haven't created a dart in the first step, the side seam on the front part might be a bit larger.
In that case, stretch, gather or pleat the fabric in the region of the bust and armpit to match the side seam lengths.

Basting the seams together first can help.
:::
