...
Mark the middle of your waistband length. Fold your waistband piece
double and mark the middle of the front width (do not take the seam allowance into
account).
...
![Joined waistband piece](step12.svg)

Press open the seam.

They will be inside the waistband, so you don't need to finish the
edges of this seam unless your fabric is particularly likely to fray.
