...
If you opted for the short sleeve version, you can ignore anything related to Cuffs and the
Sleeve Plackets. Just skip these steps.
...
If you opted for the short sleeve version, you have to sew the hem of the sleeve.

Fold back the seam allowance at the bottom of the sleeve. Then fold the hem allowance
back and press. Stitch along the edge of the hem to set it in place.

![Sew the hem](simonshortsleeve.png)
...
>
> As such, be careful to not align the fabric edge, but align the seam so that the sleeve extends out a distance of half the standard seam allowance.
...
> As such, be careful to not align the fabric edge, but align the seam so that the extra seam allowance extends out a distance of half the standard seam allowance.
