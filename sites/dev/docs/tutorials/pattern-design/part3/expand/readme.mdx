...
Here is an example snippets from [Aaron's arm binding](https://codeberg.org/freesewing/freesewing/src/branch/develop/designs/aaron/src/arm-binding.mjs#L24):
