...
First, [fork our monorepo](https://codeberg.org/freesewing/freesewing/fork). Then run:
...
[freesewing/freesewing](https://codeberg.org/freesewing/freesewing) repository on
